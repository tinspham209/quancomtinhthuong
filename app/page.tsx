		...
		<div className="">
			<div className="container">
				...
				<h3 className="text-xl font-semibold mb-4">
					Cùng đặt món, cùng tận hưởng
				</h3>
				<p className="mb-4">
					Chẳng cần thay nhau đặt món từ một máy điện thoại, chẳng cần chờ đợi
					hay lo nhầm lẫn. Với Đặt đơn nhóm, mỗi người đều có thể tự đặt món cho
					riêng mình từ điện thoại cá nhân và bỏ chung vào một giỏ hàng.
				</p>
